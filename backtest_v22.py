"""
Canyon Quant v22 — Signal & Overlay Upgrades
=============================================
Built on v21, adds:
...
# ════════════════════════════════════════════════════════════════════════════
print("\n" + "═"*W)
print("  CANYON QUANT v22 — SCORECARD")
print("═"*W)
...
# Save
results["v22 + TQQQ"][0].to_csv(ROOT/"backtest_v22_oos.csv", index=False)
results["v22 Stock-only"][0].to_csv(ROOT/"backtest_v22_stock.csv", index=False)
print(f"  Saved: backtest_v22_oos.csv, backtest_v22_stock.csv")
print("═"*W)
