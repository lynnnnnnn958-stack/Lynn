...
“simulated trade ledger”. This step does not touch real money, does not connect to a broker, and does not submit orders automatically.

It does four things:
1. Reads position_sizing_recommendations.csv / execution_gate_review.csv
2. Generates or updates paper_portfolio_ledger.csv
...
- PAPER_CANDIDATE is also not an order
...
- The Learning Engine should only learn from CLOSED_PAPER or CLOSED_REAL
"""
