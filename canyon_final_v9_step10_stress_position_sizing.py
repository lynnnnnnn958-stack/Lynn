...
Purpose:
Based on the local review table from Step 7/9, run portfolio stress tests and position scaling recommendations.

It answers:
1. If semiconductors drop 5%, how much does the portfolio roughly lose?
2. If Nasdaq/tech pulls back, which sleeve has the most risk?
3. Which candidates should be halved, skipped, or kept under REVIEW?
...
- Only uses local execution_gate_review.csv and rule-based scenario shocks
"""
